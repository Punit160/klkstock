                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default" style="border-top: 4px solid #0c1476; border-bottom: 4px solid #0c1476;">
                        <div class="card-header bg-light">
                            <h3 class="card-title">Update Biller</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        value="{{$biller->company_name}}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"
                                                 data-mask name="phone" value="{{$biller->phone}}"
                                                required />
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="status" style="width: 100%;" required>
                                            ...
                                            <option  {{ $biller->status === '1' ? 'selected' : '' }} value="1">Active</option>
                                            <option {{ $biller->status === '0' ? 'selected' : '' }} value="0">Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- /.col -->
