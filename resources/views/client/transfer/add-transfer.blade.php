                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>From Store/Warehouse/Shop *</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>To Store/Warehouse/Shop *</label>
                                        <select class="form-control select2" name="type" style="width: 100%;" required>
                                            <option disabled>Choose...</option>
                                            <option value="1">Warehouse 1</option>
                                            <option value="2">Warehouse 2</option>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><select name="types[]" id="type_0_name"
                                                                ...
                                                                <option value="">-- Choose Item --</option> @foreach
                                                                ($type as $types)<option value="{{ $types->id}}"> {{
                                                                    $types->name
                                                                    }}</option>@endforeach
                                                            </select></td>
                                                        <td> <select name="product" id="product_0_name"
                                                                class="form-control product_name product_name0"
                                                                data-index="0"><option value="">-- Choose Item --</option></select></td>
                                                        <td><input type="text" id="quantity0'" name="quantities[]"
                                                                class="form-control" /></td>
                                                        <td><input type="number" id="store0" name="stores[]"
                                                                class="form-control" /></td>
