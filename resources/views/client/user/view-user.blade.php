...
@include('client.component.sidebar')
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <a href="{{route('add-user')}}" class="btn btn-info mx-2 mb-4 btn-add-expenses" 
                ...
                @foreach($user as $users)
                  <tr>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                      <a class="dropdown-item" href="{{asset('user/update-user/'. $users->id)}}"><span><i class="fa fa-fw fa-edit"></i></span> Edit</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="{{asset('user/delete-user/'. $users->id)}}"><span><i class="fa fa-fw fa-trash"></i></span> Delete</a>
                    </div>
                  </div>
                    </td>
                  </tr>
