            ...
            <div class="col-12 col-md-6 hasVariants">
                <div class="form-group">
                    ...
                    <div id="prodbtns" class=" rounded row p-0 pt-1 gap-2 countVariant"  style="border: 1px solid #ced4da;">
                        ...
                        <input type="text" maxlength="30" name="values[]" id="prodValue.${holder[count]}"  style=" max-height: 30px;" onkeyup="checkComma(event, this)" class="inputVal form-control border-0 col mx-auto" placeholder="Enter variant separated by comma" required>
                    </div>
                </div>
            </div>
        </div>
...
function inputValuesInTable(){
  ...
  if(productArr.length != 0){
    for(let ki=0;ki<productArr.length;ki++){
      ...
      newrow.innerHTML=`
        <td>
          <input type="text" name="variation_names[]" id="varname" class="form-control" value="${productArr[ki]}" disabled>
        </td>
        <td>
    ...
    for(let ki=0;ki<colorArray.length;ki++){
      ...
      newrow.innerHTML=`
        <td>
          <input type="text" name="variation_names[]" id="varname" class="form-control" value="${colorArray[ki]}" disabled>
        </td>
        <td>
