                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Store/Warehouse/Shop *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="customFile">Upload CSV File</label>
                                    ...
                                    <p class="italic"><small>The correct column order is (product_code, quantity, purchase_unit_code, cost, discount_per_unit, tax_name) and you must follow this. All columns are required</small></p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label></label>
                                        <br>
                                        <a href="#" class="btn btn-info btn-block btn-lg"><i class="dripicons-download"></i> Download Sample File</a>
                                    </div>
                                </div>
